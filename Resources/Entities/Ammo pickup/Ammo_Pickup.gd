...
@export (int, "full size", "small") var kit_size = 0: set = kit_size_change

# index 0 = full size pickup, index 1 = small pickup
...
func _ready():
	...
	$Holder/Ammo_Pickup_Trigger.connect("body_entered", Callable(self, "trigger_body_entered"))
