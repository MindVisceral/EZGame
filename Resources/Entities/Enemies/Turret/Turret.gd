...
#var bullet_scene = preload("res://Resources/Bullet/Bullet_Scene.tscn")

func _ready():

	$Vision_Area.connect("body_entered", Callable(self, "body_entered_vision"))
	$Vision_Area.connect("body_exited", Callable(self, "body_exited_vision"))
